...
<body style="background-image: url(image/homebackgrndimg1.png);">
	...
	<div class="categolis">
		<table>
			<tr>
			<th><a href="smartphone.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Smartphone</a></th>
						...
						<div>
							<table class="rightsidemenu">
								...
								<tr>
									...
									<th><?php echo '<div class="home-prodlist-img"><a href="gadgets/view_product.php?pid='.$pId.'">
